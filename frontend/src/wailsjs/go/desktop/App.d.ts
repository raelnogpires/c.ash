...
export function ArchiveCategory(arg1:string):Promise<void>;
...
export function CreateCategory(arg1:application.CategoryInput):Promise<domain.Category>;
...
export function RenameCategory(arg1:string,arg2:application.CategoryInput):Promise<domain.Category>;
...
export function RestoreCategory(arg1:string):Promise<void>;
